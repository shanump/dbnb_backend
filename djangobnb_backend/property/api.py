...
from .serializers import PropertiesListSerializers, PropertiesDetailSerializers, ReservationsListSerializer
...
def property_reservations(request, pk):
    property = Property.objects.get(pk=pk) # GET PROPERTY
    reservations = property.reservations.all() #GET ALL RESERVATIONS ASSPCIATED WITH PRPERTY
